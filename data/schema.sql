...
CREATE TABLE autos( 
    id_auto integer NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
CREATE USER 'userdemo'@'localhost' IDENTIFIED BY 'user.2018';
GRANT ALL PRIVILEGES ON practica.* TO 'userdemo'@'localhost';
FLUSH PRIVILEGES;
